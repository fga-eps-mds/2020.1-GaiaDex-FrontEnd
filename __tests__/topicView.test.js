...
describe('<TopicCreate />', () => {
    ...
    it('renders KeyboardAvoidingView correctly', () => {
        expect(wrapper.find('KeyboardAvoidingView').at(0)).toHaveStyle(styles.containerMaster);
    ...
    it('renders ScrollView correctly', () => {
        expect(wrapper.find('ScrollView').at(0)).toHaveStyle(styles.scrollViewDescription);
    ...
    it('renders TouchableOpacity correctly', () => {
      expect(wrapper.find('TouchableOpacity').at(0)).toHaveStyle(styles.commentsBarDiv);
