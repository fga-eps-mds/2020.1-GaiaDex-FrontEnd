...
describe('<Update />', () => {
  ...
  it('renders Text Input correctly', () => {
    expect(wrapper.find('TextInput').at(0)).toHaveStyle(
      styles.textinputRegform
    );
    expect(wrapper.find('TextInput').at(1)).toHaveStyle(
      styles.textinputRegform
    );
    expect(wrapper.find('TextInput').at(2)).toHaveStyle(
      styles.textinputRegform
    );
    ...
    expect(wrapper.find('TextInput').at(2)).toHaveProp(
      'underlineColorAndroid',
      'transparent'
    );
  ...
  it('renders Text correctly', () => {
    ...
    expect(wrapper.find('Text').at(8)).toHaveStyle(
      styles.txtBtnFbGoogleRegform
    );
    expect(wrapper.find('Text').at(8)).toHaveText('Fazer login com o Facebook');
    expect(wrapper.find('Text').at(12)).toHaveStyle(
      styles.txtBtnFbGoogleRegform
    );
